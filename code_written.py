...
#project-id:dataset_id.table_id
other_table_spec = 'try-dummy-project:dataset_food_orders.other_status_orders'
...
view_to_create.view_query = 'select * from `try-dummy-project.dataset_food_orders.delivered_orders` where _PARTITIONDATE = DATE(current_date())'
